<!-- ini adalah halaman layout -->
<!-- layout merupakan halaman website yang akan selalu ditampilkan pada beberapa view -->
<!-- agar tidak mengulang kode yang sama disetiap beberapa view, maka digunakanlah view layout -->
<!-- $this->renderSection('content') digunakan untuk memanggil view didalam halaman layout -->
<!-- setiap view yang ingin menggunakan layout harus meng-extend layoutnya $this->extend('layout/page_layout')  -->
<!-- kemudian konten view harus dituliskan diantara tag php $this->section('content') & $this->endSection() -->
<!-- halaman layout merupakan halaman yang dinamis, karena dapat menampilkan view yang berbeda-beda -->
      ...
      <div class="main-wrapper">
        ...
        <div class="main-sidebar">
          <aside id="sidebar-wrapper">
            ...
            <!-- perintah memanggil halaman dinamis menu -->
        ...
        <div class="main-content">
          <!-- perintah memanggil halaman dinamis content -->
        ...
        <footer class="main-footer">
          <div class="footer-left">
            ...
            Developed By <a href="">Muhammad Aditya</a>
          </div>
